...
**What you can do:**
- Use any of your 93 skills at `~/.claude/skills/` — read the skill file before performing that task
...
3. Search for `@BotFather` in Telegram (blue checkmark)
4. Click Start, type `/newbot`
5. Name the bot anything, username must end in `bot`
...
Common fixes:
- Skills not loading → check `~/.claude/skills/` has folders, re-copy from `~/workshop-kit/skills/`
...
- Workshop kit source: `~/workshop-kit/`
