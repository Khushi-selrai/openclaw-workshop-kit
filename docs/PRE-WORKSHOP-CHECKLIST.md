...
Claude is the AI that powers your assistant. You need a Claude Max subscription.

1. Open your browser and go to: [claude.ai](https://claude.ai)
2. Click **Sign Up** (or Log In if you already have an account)
3. Go to **Settings → Billing → Upgrade Plan**
4. Choose **Claude Max** — $100 USD/month
...
3. Open the downloaded `.zip` file — it extracts to a `Visual Studio Code.app` file
4. Drag `Visual Studio Code.app` to your **Applications** folder
5. Open VS Code from Applications (right-click → Open the first time, to allow it)
